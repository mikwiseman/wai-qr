    ...
    return (
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Pre-Fill from LinkedIn</h2>
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-1">Pre-Fill from LinkedIn</h3>
